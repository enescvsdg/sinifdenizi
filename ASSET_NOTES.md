...
Atlasın çizimleri tam eşit hücrelere oturmadığından `components/sprites.tsx` tür başına ayrı SVG görüntüleme alanları ve kırpma maskeleri tanımlar. PNG dosyası değiştirilmez; alfa kanalı korunur.
